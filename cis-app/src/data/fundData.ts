...
export const FUND_DATA: Omit<FundInputs, 'id' | 'custom'>[] = [
  ...
  { ticker: 'JEPI', name: 'JPMorgan Equity Premium Income ETF', category: 'covered', yield: 8.2, expense: 0.35, growth: 'Low', risk: 'Medium', frequency: 'Monthly' },
  { ticker: 'JEPQ', name: 'JPMorgan Nasdaq Equity Premium Income ETF', category: 'covered', yield: 10.6, expense: 0.35, growth: 'Low', risk: 'High', frequency: 'Monthly' },
  { ticker: 'QYLD', name: 'Global X Nasdaq 100 Covered Call ETF', category: 'covered', yield: 12.0, expense: 0.6, growth: 'Low', risk: 'High', frequency: 'Monthly' },
  { ticker: 'XYLD', name: 'Global X S&P 500 Covered Call ETF', category: 'covered', yield: 10.2, expense: 0.6, growth: 'Low', risk: 'High', frequency: 'Monthly' },
  { ticker: 'DIVO', name: 'Amplify CWP Enhanced Dividend Income ETF', category: 'covered', yield: 4.8, expense: 0.56, growth: 'Medium', risk: 'Medium', frequency: 'Monthly' },
